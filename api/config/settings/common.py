...
PAGINATION = {
    ...
    "FOOTPRINTS": int(env("PAGINATION_FOOTPRINTS", 5)),
    "MANUFACTURERS": int(env("PAGINATION_MANUFACTURERS", 10)),
    "DISTRIBUTORS": int(env("PAGINATION_DISTRIBUTORS", 10)),
    "STORAGES": int(env("PAGINATION_STORAGES", 10)),
    "PART_UNITS": int(env("PAGINATION_PART_UNITS", 10)),
    "PARAMETERS_UNITS": int(env("PAGINATION_PARAMETERS_UNITS", 10)),
    "PARTS": int(env("PAGINATION_PARTS", 10)),
    "ORDERS_IMPORTER": int(env("PAGINATION_ORDERS_IMPORTER", 10)),
}
