    ...
    def __call__(self, fileobj):
        ...
        if detected_type not in self.allowed_mimes and detected_type.split("/")[0] not in self.allowed_mimes:
            raise ValidationError(
                ...
                params={"detected_type": detected_type, "allowed_types": ", ".join(self.input_allowed_types)},
                code="invalid_type",
            )
        ...
        if self.allowed_exts and (extension not in self.allowed_exts):
            raise ValidationError(
                ...
                params={"extension": extension, "allowed_extensions": ", ".join(self.allowed_exts)},
    ...
    def _normalize(self, allowed_types):
        ...
        for allowed_type in allowed_types:
            ...
            if len(parts) == 2:
                ...
                raise ValidationError(
                    message=self.invalid_message, params={"allowed_type": allowed_type}, code="invalid_input"
                )
