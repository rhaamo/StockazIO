    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('part', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='part_parameters', to='part.Part')),
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='part.ParametersUnit')),
            ],
            options={
                'ordering': ('name',),
            },
